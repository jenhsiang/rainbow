                ...
                for($i=0; $i<count($photo); $i++)
                {
                    ...
                    <div class="clear" >
                        ...
                        for($x=0; $x<4; $x++)
                        {
                            ...
                            ?>
                            <div class="product" style="border-bottom: dashed; margin-bottom: 8px;"><span style="background-image:url('<?echo $base_url;?>service_img/<?echo $photo[$i+$x]["img"];?>')" class="productImg"></span>
                                <p class="proA"><textarea name="<?echo $photo[$i+$x]["id"];?>" style="border-style: solid; border-width: 1px; border-color: #d4d2d2;width: 100%;"><?echo $photo[$i+$x]["intro"];?></textarea></p>
                                <button class="proD" name="update" value="<?echo $photo[$i+$x]["id"];?>" style="margin-bottom: 5px;">更新</button>
                                <button class="proD" name="remove" value="<?echo $photo[$i+$x]["id"];?>">刪除</button>
                            </div>

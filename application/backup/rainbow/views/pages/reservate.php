...
<section class="reservate">
    ...
    <div class="reservateList">
        ...
        <div class="reservateChoice">
            <input placeholder="尚餘<? if(!empty($member)){echo $member["gold2"];}?>" type="number" value="" id="gold2" name="gold2" max="<? if(!empty($member["gold2"]) && $member["gold2"] > 100){echo "100";}else{echo $member["gold2"];}?>" onchange="check_gold2(this)">
        </div>
    ...
    <div class="reservateList">
        ...
        <div class="reservateChoice">
            <input placeholder="尚餘<? if(!empty($member)){echo $member["gold"];}?>" type="number" value="" id="gold" name="gold" max="<? if(!empty($member)){echo $member["gold"];}?>" onchange="check_gold(this)">
        </div>

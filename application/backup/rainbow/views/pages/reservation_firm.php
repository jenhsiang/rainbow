...
<form action="?" method="post">
    <section class="record">
        ...
        <div class="recordTime">
            <p><img src="<?echo $base_url;?>assets_view/images/clock.png"><span class="date">日期/時段</span><span><input name="re_date" value="<?echo $service[0]["re_date"];?>" style="border-width:1px; border-color: #0d3349; border-style: solid; "></span><span><input name="re_time" value="<?echo $service[0]["re_time"];?>-<?echo $service[0]["re_time2"];?>" style="border-width:1px; border-color: #0d3349; border-style: solid; "></span></p>
        </div>
        ...
        <div class="service">
            ...
            <p class="serviceB">預約地點：<?echo $service[0]["address"];?></p>
            <p class="serviceB">預約人： <?echo $service[0]["user_name"];?></p>

    ...
    <div class="reservateList">
        ...
        <div class="reservateChoice">
            <select name="score">
                ...
                ?>
                <option value="1" <?if($score[0]["score"] == 1){ echo "selected";}?>>1分 - 不會再來</option>
                <option value="2" <?if($score[0]["score"] == 2){ echo "selected";}?>>2分 - 勉強接受</option>
                <option value="3" <?if($score[0]["score"] == 3){ echo "selected";}?>>3分 - 捧場支持</option>
                <option value="4" <?if($score[0]["score"] == 4){ echo "selected";}?>>4分 - 過人水平</option>
                <option value="5" <?if($score[0]["score"] == 5){ echo "selected";}?>>5分 - 彩虹之光</option>
                <?
                }else{
                ?>

...
<div style="padding-top: 20px;">
    <div style="width: 90%; float: left; margin-left: 10%; line-height: 30px;color: #edbb64;font-size: 22px;margin-top: 15px;"><p><? echo '<img src="'.$base_url.'assets_view/images/gold.png" style="height:20px;">'.$member[0]["gold"]; ?></p></div>
    <div style="width: 90%; float: left; margin-left: 10%; line-height: 30px;color: #888279;font-size: 22px;margin-top: 15px;"><p><? echo '<img src="'.$base_url.'assets_view/images/gold2.png" style="height:20px;">'.$member[0]["gold2"]; ?></p></div>
</div>
...
<section class="score">
    ...
    ?>
        <a href="<?echo $base_url.'index.php/reservation?id='.$item["id"]?>" class="scoreList">
                <div class="scoreImg"><img src="<?echo $base_url;?>service_img/<?echo $item["img"];?>"></div>
                <div class="pname">
                    <p><?echo $item["name"];?></p>
                    <p>消費金額： NT$ <?echo $item["fee"];?></p>
                    <? echo '<p>使用金幣：'.$item["gold"].'使用銀幣：'.$item["gold2"].'</p>';?>
    ...
    if(!empty($member_list))
    {
        foreach($member_list as $item)
        {
            ...
            <a href="" class="scoreList">
                <div class="scoreImg"><p><?echo $item["name"];?></p></div>
                <div class="pname">

                    <p>獲得銀幣：100 <span style="float: right;"><?echo $item["join_time"];?></span></p>

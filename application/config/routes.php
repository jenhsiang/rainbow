...
$route['m_count_list'] = 'index/m_count_list';
$route['detail1'] = 'index/detail1';
$route['detail2'] = 'index/detail2';
$route['detail3'] = 'index/detail3';

$route['backend/firm_list'] = 'backend/firm_list';
$route['backend/member_list'] = 'backend/member_list';
$route['backend/service_list'] = 'backend/service_list';
$route['backend/order_list'] = 'backend/order_list';
$route['backend/a_list'] = 'backend/a_list';
$route['backend/m_count'] = 'backend/m_count';
$route['backend/m_count_lisr'] = 'backend/m_count_lisr';
$route['backend/set'] = 'backend/set';
$route['backend/login'] = 'backend/login';
$route['backend'] = 'backend/login';
$route['backend/y_count'] = 'backend/y_count';
$route['backend/y_count_lisr'] = 'backend/y_count_lisr';

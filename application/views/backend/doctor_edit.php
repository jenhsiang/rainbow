                    ...
                    <form class="form-horizontal" action="?" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" id="typeahead"  data-provide="typeahead" data-items="4" name="name" value="<?php if(!empty($content[0]["name"])){echo $content[0]["name"];}?>">
                                    <p class="help-block"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="fileInput">照片上傳</label>
                                <div class="controls">
                                    <?php
                            ...
                            <div class="control-group">
                                <label class="control-label" for="select01">專長</label>
                                <div class="controls">
                                    <textarea  id="skill" name="skill" style="width: 600px; height: 200px"><?php if(!empty($content[0]["skill"])){echo $content[0]["skill"];}?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="select01">現職</label>
                                <div class="controls">
                                    <textarea  id="now" name="now" style="width: 600px; height: 200px"><?php if(!empty($content[0]["now"])){echo $content[0]["now"];}?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="select01">學歷</label>
                                <div class="controls">
                                    <textarea  id="edu" name="edu" style="width: 600px; height: 200px"><?php if(!empty($content[0]["edu"])){echo $content[0]["edu"];}?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="select01">經歷</label>
                                <div class="controls">
                                    <textarea  id="exp" name="exp" style="width: 600px; height: 200px"><?php if(!empty($content[0]["exp"])){echo $content[0]["exp"];}?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="select01">論文</label>
                                <div class="controls">
                                    <textarea id="edm_content" name="edm_content" style="width: 600px; height: 200px"><?php if(!empty($content[0]["paper"])){echo $content[0]["paper"];}?></textarea>
                                </div>
                            </div>
                            <div class="control-group">

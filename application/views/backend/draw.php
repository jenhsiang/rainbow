    ...
    <div class="row-fluid">
        <div class="span3" id="sidebar">
            <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                <li>
                    <a href=""><i class="icon-chevron-right"></i> 設定抽成</a>
                </li>
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">設定抽成</div>
                    </div>
                            ...
                            <form class="form-horizontal" action="?" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label">抽成百分比(%)<span class="required">*</span></label>
                                        <div class="controls">
                                            <input name="draw" type="number" class="span6 m-wrap" value="<?echo $draw[0]["draw"];?>" max="100" />
                                        </div>
                                    </div>

                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" name="save" value="1">更新</button>
                                    </div>
                                </fieldset>
                            </form>

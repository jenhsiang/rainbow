            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">編輯首頁熱門項目</div>
                    </div>
                            ...
                            <form class="form-horizontal" action="?" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="control-group success">
                                        <label class="control-label" for="selectError">標題</label>
                                        <div class="controls">
                                            <input name="title" type="text" class="span6 m-wrap" value="<?php if(isset($special_item)){echo $special_item[0]["title"];}?>" />
                                        </div>
                                    </div>
                                    <div class="control-group success">
                                        <label class="control-label" for="selectError">型式</label>
                                        <div class="controls">
                                            <select id="selectError" name="type">
                                                <option <?php if(isset($special_item[0]) && $special_item[0]["type"] == 1){echo "selected";}?>>1</option>
                                                <option <?php if(isset($special_item[0]) && $special_item[0]["type"] == 2){echo "selected";}?>>2</option>
                                                <option <?php if(isset($special_item[0]) && $special_item[0]["type"] == 3){echo "selected";}?>>3</option>
                                            </select>
                                            <span class="help-inline"></span>
                                        </div>
                                    </div>
                                    <div class="control-group success">
                                        <label class="control-label" for="selectError">服務項目</label>
                                        <div class="controls">
                                            <select id="selectError" name="service_id">
                                                <?php
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $item["id"]; ?>" <?php if($special_item[0]["service_id"] == $item["id"]){echo "selected";}?>> <?php echo $item["name"]; ?> </option>
                                                            <?php
                                                        }
                                                    }
                                    ...
                                    <div class="form-actions">
                                        <?php
                                            if(isset($special_item))
                                            {
                                                echo '<button type="submit" class="btn btn-primary" name="update" value="'.$special_item[0]["id"].'">更新</button>';
                                            }else
                                            {
                                                echo '<button type="submit" class="btn btn-primary" name="save" value="1">新增</button>';
                                            }
                                        ?>

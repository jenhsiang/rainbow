                    ...
                    <div class="block-content collapse in">
                        ...
                        <div class="span12">
                            ...
                            <div class="table-toolbar">
                                <div class="btn-group">
                                    <a href="#"><button class="btn btn-success" name="down_all" value="1">全部確認付款 <i class="icon-plus icon-white"></i></button></a>
                            ...
                            <p> 總營收：<?php echo $total?>  應付款項：：<?php echo $total_pay?>  總盈餘：<?php echo $total_get?> </p>
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                if(!empty($count))
                                {
                                    foreach($count as $item)
                                    {
                                        ...
                                        echo '<td>'.$item["money"]*($item["p"]/100)."(".$item["p"]."%)".'</td>';
                                        echo '<td>'.$item["money"]*(1-$item["p"]/100).'</td>';
                                        echo '<td>'.$item["state"].'</td>';
                                        echo '<td class="center"> <button style="width: 100%;" name="down" value="'.$item["id"].'">確認付款</button></td>';
                                        echo '</tr>';
                                    }
                                }
                                ?>

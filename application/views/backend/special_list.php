                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <div class="table-toolbar">
                                <div class="btn-group">
                                    <a href="#"><button class="btn btn-success" name="new" value="1">新增<i class="icon-plus icon-white"></i></button></a>
                                </div>
                            </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                if(!empty($special_item))
                                {
                                    foreach($special_item as $item)
                                    {
                                        ...
                                        echo '<td class="center"><button style="width: 100%;" name="edit" value="'.$item["id"].'">編輯</button><button style="width: 100%;" name="del" value="'.$item["id"].'">刪除</button></td>';

...
<div class="login">
    <div class="inputAll">
        <input placeholder="手機" type="text" value="" name="acc" class="loginInput">
        <div class="number">
            <input placeholder="密碼" type="password" value="" name="psd" class="loginInput"><a href="<?php echo $base_url.'index.php/firm_forget';?>" class="link">忘記密碼?</a>
        </div>
    </div>
    <div class="inputAll">

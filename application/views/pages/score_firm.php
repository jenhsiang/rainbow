    ...
    <div class="reservateList">
        ...
        <div class="reservateChoice">
            <select name="score">
                ...
                ?>
                <option value="1" <?php if($score[0]["score"] == 1){ echo "selected";}?>>1</option>
                <option value="2" <?php if($score[0]["score"] == 2){ echo "selected";}?>>2</option>
                <option value="3" <?php if($score[0]["score"] == 3){ echo "selected";}?>>3</option>
                <option value="4" <?php if($score[0]["score"] == 4){ echo "selected";}?>>4</option>
                <option value="5" <?php if($score[0]["score"] == 5){ echo "selected";}?>>5</option>
                    <?php
                }else{
                ?>

<section class="score">
    ...
    ?>
                <div class="scoreList stardiv<?php echo $score[$i]["score"];?>">
                    <!--<div class="scoreImg"><img src="<?php echo $base_url;?>assets_view/images/productB.png"></div>-->
                    <div class="pname">
                        ...
                        <p><?php echo $score[$i]["time"];?></p>
                        <p><?php echo $score[$i]["content"];?></p>
                    </div>
                </div>
                <?php
            }

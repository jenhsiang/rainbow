<div class="login">
    ...
    <div class="selectAll">
        ...
        <select class="loginInput" name="cat">
            ...
            if(!empty($cat))
            {
                ...
                {
                    ?>
                    <option value="<?php echo $cat[$i]["id"];?>" <?php  if(isset($service["cat"]) && $service["cat"] == $cat[$i]["id"]){echo "selected";}?>><?php echo $cat[$i]["name"];?></option>
                    <?php
                }
            }
            ?>
    ...
    <div class="upload">
        ...
        <div class="inputAll">
        <input placeholder="服務名稱(必填)" type="text" value="<?php if(!empty($service["name"])){echo $service["name"];}?>" name="name" class="loginInput">
        <input placeholder="服務員姓名(必填)" type="text" value="<?php if(!empty($service["attendant"])){echo $service["attendant"];}?>" name="attendant" class="loginInput">
        <textarea placeholder="服務簡介(必填)" type="text" value="" name="intro" class="loginInput"><?php if(!empty($service["intro"])){echo $service["intro"];}?></textarea>
        <textarea placeholder="服務人介紹(必填)" type="text" value="" name="attendant_intro" class="loginInput"><?php if(!empty($service["attendant_intro"])){echo $service["attendant_intro"];}?></textarea>
    </div>
    <div class="selectAll">
        <p>服務時間設定</p>
        ...
        <select class="loginInput" name="way" onchange="changeway(this)">
            <option value="1" <?php  if(isset($service["way"]) && $service["way"] == 1){echo "selected";}?>>到府服務</option>
            <option value="2" <?php  if(isset($service["way"]) && $service["way"] == 2){echo "selected";}?>>店內服務</option>
            <option value="3" <?php  if(isset($service["way"]) && $service["way"] == 3){echo "selected";}?>>兩者皆有</option>
        </select>
        <p id="city_title" style="display: <?php  if(isset($service["way"]) && $service["way"] == 1){echo "none";}else{echo "block";}?>;">請選擇所在區域</p>
        <select class="loginInput" name="city" id="city" style="display: <?php  if(isset($service["way"]) && $service["way"] == 1){echo "none";}else{echo "block";}?>;">
            <?php
            if(isset($city))
                {
                    ...
                    {
                        ?>
                        <option value="<?php echo $item["id"]?>" <?php  if(isset($service["city"]) && $service["city"] == $item["id"]){echo "selected";}?>><?php echo $item["city"]?></option>
                        <?php
                    }
                }
            ?>
        </select>
        <select class="loginInput" name="zone" id="zone" style="display: <?php  if(isset($service["way"]) && $service["way"] == 1){echo "none";}else{echo "block";}?>;">
            <?php
            if(isset($area))
            {
                ...
                {
                    ?>
                    <option value="<?php echo $item["id"]?>" <?php  if(isset($service["zone"]) && $service["zone"] == $item["id"]){echo "selected";}?>><?php echo $item["area"]?></option>
                    <?php
                }
            }
            ?>
        ...
        <div class="inputAll">
            <input placeholder="店址(必填)" type="text" value="<?php if(!empty($service["address"])){echo $service["address"];}?>" name="address" class="loginInput" id="address" style="display: <?php  if(isset($service["way"]) && $service["way"] == 1){echo "none";}else{echo "block";}?>;">
        </div>
        <p>是否停止服務</p>
        <select class="loginInput" name="ready" id="ready">
            <option value="1" <?php  if(isset($service["ready"]) && $service["ready"] == 1){echo "selected";}?>>否</option>
            <option value="2" <?php  if(isset($service["ready"]) && $service["ready"] == 2){echo "selected";}?>>是</option>
        </select>

    </div>

    <div class="inputAll">
        <input placeholder="價格(必填)" type="text" value="<?php if(!empty($service["fee"])){echo $service["fee"];}?>" id="fee" name="fee" class="loginInput">
        <input placeholder="彩虹價格(必填)" type="text" value="<?php if(!empty($service["special_fee"])){echo $service["special_fee"];}?>" id="special_fee" name="special_fee" class="loginInput">
    </div>
